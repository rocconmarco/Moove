...
export class AuthorizedMinterAdded extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save AuthorizedMinterAdded entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type AuthorizedMinterAdded must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("AuthorizedMinterAdded", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): AuthorizedMinterAdded | null {
    return changetype<AuthorizedMinterAdded | null>(
      store.get_in_block("AuthorizedMinterAdded", id.toHexString()),
    );
  }

  static load(id: Bytes): AuthorizedMinterAdded | null {
    return changetype<AuthorizedMinterAdded | null>(
      store.get("AuthorizedMinterAdded", id.toHexString()),
    );
  }
...
export class AuthorizedMinterRemoved extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save AuthorizedMinterRemoved entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type AuthorizedMinterRemoved must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("AuthorizedMinterRemoved", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): AuthorizedMinterRemoved | null {
    return changetype<AuthorizedMinterRemoved | null>(
      store.get_in_block("AuthorizedMinterRemoved", id.toHexString()),
    );
  }

  static load(id: Bytes): AuthorizedMinterRemoved | null {
    return changetype<AuthorizedMinterRemoved | null>(
      store.get("AuthorizedMinterRemoved", id.toHexString()),
    );
  }
  ...
  get formerMinter(): Bytes {
    let value = this.get("formerMinter");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set formerMinter(value: Bytes) {
    this.set("formerMinter", Value.fromBytes(value));
  }
