...
export class AuthorizedMinterAdded extends ethereum.Event {
  get params(): AuthorizedMinterAdded__Params {
    return new AuthorizedMinterAdded__Params(this);
  }
}

export class AuthorizedMinterAdded__Params {
  _event: AuthorizedMinterAdded;

  constructor(event: AuthorizedMinterAdded) {
    this._event = event;
  }
...
export class AuthorizedMinterRemoved extends ethereum.Event {
  get params(): AuthorizedMinterRemoved__Params {
    return new AuthorizedMinterRemoved__Params(this);
  }
}

export class AuthorizedMinterRemoved__Params {
  _event: AuthorizedMinterRemoved;

  constructor(event: AuthorizedMinterRemoved) {
    this._event = event;
  }

  get formerMinter(): Address {
    return this._event.parameters[0].value.toAddress();
  }
}
...
export class MooveNFT extends ethereum.SmartContract {
  static bind(address: Address): MooveNFT {
    return new MooveNFT("MooveNFT", address);
  }
  ...
  checkIfAuthorizedMinter(minter: Address): boolean {
    let result = super.call(
      "checkIfAuthorizedMinter",
      "checkIfAuthorizedMinter(address):(bool)",
  ...
  try_checkIfAuthorizedMinter(minter: Address): ethereum.CallResult<boolean> {
